...
| `paste_declaration_block`| Paste class or function                                                                           | `#PDB <file_path> <declaration_name>`                    | `<only_declaration_and_docstring: bool>`                                                              |
...
| `run_unittest`           | Run unittests on a file                                                                           | `#unittest <file_path>`                                  | `<verbosity: int>`                                                                                    |
| `directory_tree`         | Get directory tree layout                                                                         | `#tree <directory_path>`                                 | `<max_depth: int, include_files: List[str], ignore_list: List[str]>`                                  |
| `summarize_python_script`| Summarize a Python script                                                                         | `#summarize <script_path>`                               | `<include_definitions_without_docstrings: bool>`                                                      |
| `summarize_folder`       | Summarize all Python scripts in a folder                                                          | `#summarize_folder <folder_path>`                        | `<include_definitions_without_docstrings: bool, excluded_dirs: List[str], exclude: List[str]>`        |
