...
class TaskBase(ABC):
    ...
    ----------
    NAME (str)
        A class-level attribute that identifies the name of the task.
    """
    ...
    def __init__(self, default_root, *default_args):
        ...
        ----------
        default_root (str)
            The default root directory for task execution.
        default_args (tuple)
            Additional default arguments required by the task.
        """
    ...
    def _initialize_arguments(self):
        ...
        additional_args based on the command line arguments. If no arguments
        are provided, uses the default root and arguments.
        """
    ...
    def _print_execution_end(self, additional_msg=""):
        ...
        ----------
        additional_msg (str)
            Optional additional message to include in the completion printout.
        """
        msg = self.line_sep
