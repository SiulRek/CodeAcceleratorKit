import unittest
from tasks.utils.for_automatic_prompt.format_identifiers_as_code import format_identifiers_as_code, is_maybe_identifier, is_camel_case, is_snake_case
...
class TestFormatLiteralsAsCode(unittest.TestCase):
    ...
    def test_format_identifiers_as_code_mixed(self):
        self.assertEqual(format_identifiers_as_code("hello world! This_isATest for_snakeCase, andCamelCase."),
